...
class Widget(QWidget):
    ...
    def q_timer_timeout(self) -> None:
        ...
        q_text_document.setPlainText(
            str(
                [
                    f"channel_configuration={q_audio_device.channelConfiguration()}, description={q_audio_device.description()}, id={q_audio_device.id()}, is_default={q_audio_device.isDefault()}, maximum_channel_count={q_audio_device.maximumChannelCount()}, maximum_sample_rate={q_audio_device.maximumSampleRate()}, minimum_channel_count={q_audio_device.minimumChannelCount()}, minimum_sample_rate={q_audio_device.minimumSampleRate()}, mode={q_audio_device.mode()}, preferred_format={q_audio_device.preferredFormat()}, supported_sample_formats={q_audio_device.supportedSampleFormats()}"
